...
The high-level \gls{Release} Management plan for \gls{DM} is documented in \citeds{LDM-294}, section 3.6. 


\subsection{Definitions} \label{sec:defs}

The relevant definition to be considered when working on release policy and process are given in the draft \citeds{DMTN-106}, section 2 ( \url{https://dmtn-106.lsst.io/v/review/index.html}).
