...
It is important to identify the correct release policy during contraction phase, in order to have it consolidated when operations starts.

Once in operations, some of the LSST subsystems mentioned here may not be relevant anymore, but the policy defined here shall still be applicable, since many of the stakeholders will still expect software releases to be managed properly. 
...
As a first glance, it seems  that major releases need to be done more on a feature or milestone bases. 

However before this assessment need further evaluation and clearly identify which of the above requirements is applicable for each of the software products  in appendix \ref{sec:swptree}.
This extra information shall be included in MagicDraw and documented in \citeds{DMTN-104}, still draft.
