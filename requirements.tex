...
In order to properly set-up the release process, all \gls{SW} products involved need to be well identified, as per definition in \citeds{DMTN-106} subsection 2.2 (see \ref{sec:defs}).

All software releases shall be properly documented with a software release note as per definition in \citeds{DMTN-106} subsection 2.4 (see \ref{sec:defs}), and tested before making them available for operations.
...
%%%%%% commented since  out of scope, added forth point in the above bullet list
