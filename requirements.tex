...
\citeds{DMTN-106} subsection 2.2 (see \ref{sec:defs}) provides a SW product definition that can be used as a starting point to identify the DM software products.
The DM product tree availabe with \citeds{LDM-294} list the 
