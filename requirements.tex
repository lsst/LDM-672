...
Other \gls{LSST} subsystem may be consumers of \gls{DM} software products, for example the \gls{TS} subsystem software makes use of the \gls{DM} software products to run  \gls{TS} software. 
